...
<table>
  <tr>
    <td width="50%" valign="top">
      <div align="center">
        <h3>🏢 AMC Campus Connect</h3>
        <img src="https://img.shields.io/badge/Full_Stack-MERN-61DAFB?style=flat-square" />
        <img src="https://img.shields.io/badge/AI-Botpress-7928CA?style=flat-square" />
        <img src="https://img.shields.io/badge/DB-MongoDB_&_Firebase-47A248?style=flat-square" />
      </div>
      <br/>
      <p><b>Unified digital intelligence hub for collegiate communities.</b></p>
      <ul>
        <li>🤖 Automated 24/7 AI chatbot resolving campus queries instantly.</li>
        <li>🔐 Role-based authentication (Students, Faculty, Admins).</li>
        <li>📢 Real-time notice boards, academic repositories, and event managers.</li>
      </ul>
      <p align="center">
        <code>React</code> • <code>Node.js</code> • <code>Express</code> • <code>MongoDB</code> • <code>Botpress</code>
      </p>
    </td>
    <td width="50%" valign="top">
      <div align="center">
        <h3>⚡ Shortify</h3>
        <img src="https://img.shields.io/badge/TypeScript-Strict-007ACC?style=flat-square" />
        <img src="https://img.shields.io/badge/Analytics-Realtime-FF0080?style=flat-square" />
        <img src="https://img.shields.io/badge/Architecture-REST-00DFD8?style=flat-square" />
      </div>
      <br/>
      <p><b>High-throughput URL optimizer with live telemetry dashboard.</b></p>
      <ul>
        <li>📊 Deep telemetry: geolocation heatmaps, referrers, and device stats.</li>
        <li>⚡ Sub-10ms redirect latency with intelligent caching.</li>
        <li>🛡️ Custom vanity aliases with collision-proof hashing algorithms.</li>
      </ul>
      <p align="center">
        <code>React</code> • <code>TypeScript</code> • <code>Express.js</code> • <code>MongoDB</code>
      </p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <div align="center">
        <h3>📍 GeoBuss</h3>
        <img src="https://img.shields.io/badge/Mobile-Flutter-02569B?style=flat-square" />
        <img src="https://img.shields.io/badge/Location-Geofencing-4285F4?style=flat-square" />
        <img src="https://img.shields.io/badge/Cloud-Firebase-FFCA28?style=flat-square" />
      </div>
      <br/>
      <p><b>Autonomous contextual device profile manager.</b></p>
      <ul>
        <li>🎯 Automatically toggles ringer/silent/vibration modes via geofencing.</li>
        <li>🔋 Battery-optimized background coordinate tracking service.</li>
        <li>🎨 Interactive map UI for defining customizable radius triggers.</li>
      </ul>
      <p align="center">
        <code>Flutter</code> • <code>Dart</code> • <code>Firebase</code> • <code>GPS Core</code>
      </p>
    </td>
    <td width="50%" valign="top">
      <div align="center">
        <h3>🎓 Siksha Sethu</h3>
        <img src="https://img.shields.io/badge/Social_Impact-Education-00F5A0?style=flat-square" />
        <img src="https://img.shields.io/badge/Frontend-React-61DAFB?style=flat-square" />
        <img src="https://img.shields.io/badge/Database-Firebase-FFCA28?style=flat-square" />
      </div>
      <br/>
      <p><b>Scholarship discovery platform bridging financial gaps in education.</b></p>
      <ul>
        <li>🔍 Multi-tier eligibility filters based on merit, course & income.</li>
        <li>📅 Automated application deadline alerts and bookmark system.</li>
        <li>📱 Ultra-accessible UI built for both desktop and mobile viewports.</li>
      </ul>
      <p align="center">
        <code>React</code> • <code>Firebase</code> • <code>TailwindCSS</code>
      </p>
    </td>
  </tr>
</table>
...
&nbsp;&nbsp;
<a href="mailto:rakshakpatel2005@gmail.com">
  <img src="https://img.shields.io/badge/Direct_Email-Say_Hello-EA4335?style=for-the-badge&logo=gmail&logoColor=white" alt="Email"/>
</a>
&nbsp;&nbsp;
<a href="https://instagram.com/rakshak_2005" target="_blank">
